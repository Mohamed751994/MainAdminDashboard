...
[
    ...
    'routeName'=>'blogs',
    'inputs' =>[
        ['type' => 'select', 'required' =>false, 'name'=>'category_id', 'label' =>__('text.Category'),'value' =>$content->category_id,'compact'=>$compact['category_id']],
        ...
        ['type' => 'text', 'required' =>false, 'name'=>'tags', 'label' => __('text.Tags'), 'value' =>$content->tags],
    ],
    'status_order' =>true,
    'home_display' =>true,
])

<div class="row align-items-center justify-content-start">
    ...
    <div class="col-md-4 mt-3">
        ...
        <input type="number" min="0" value="{{$content->sort}}" name="sort" class="form-control" placeholder="ترتيب العنصر...">
    </div>
    ...
    <div class="col-md-4 mt-3">
        <label class="form-check-label" for="flexSwitchCheckCheckedd">إظهار في الصفحة الرئيسية</label>
        <div class="form-check form-switch mt-2">
            <input class="form-check-input customSliderCheckbox" type="checkbox"
